...
fil["11"]= "Hide_Concept.html@@@Hide@@@The Hide function removes nodes from the visualization...";
...
fil["24"]= "Select_Concept.html@@@Select@@@Before a command can be performed, the user must first Select the desired nodes. Use the Select function to choose which nodes to execute a command on...";
fil["25"]= "Select_Manually.html@@@Select Manually@@@Select nodes by hand with the following steps...";
fil["26"]= "Select_Set_Class.html@@@Select by Set or Class@@@Select nodes by Set or Class using the Commands Tab...";
fil["27"]= "SettingsGuide.html@@@Settings Tab@@@Adjusting the appearance using the Settings Tab...";
fil["28"]= "Shelve_Concept.html@@@Shelve@@@The Shelve function returns nodes to the the outer ring that orbits the central graph...";
fil["29"]= "Shelve_Manually.html@@@Shelve Manually@@@Shelve nodes using the  drag and drop  method with the following steps...";
fil["30"]= "ViewEdges.html@@@View Edges@@@Edges are displayed both in the Graph and in the Commands Tab...";
fil["31"]= "View_Snippet.html@@@View Snippet Window@@@Snippet windows allow users to explore the relationships between nodes in more detail. In the HuViz prototype, the  snippet  of text is extracted from the source entry on the Orlando Project...";
